...
const DISABLED_SECTIONS = ["alugar","stats","favoritos"];

const SOCIAL = {"instagram":"https://instagram.com/suimobiliaria","facebook":"https://facebook.com/suimobiliaria","youtube":"https://youtube.com/@suimobiliaria","linkedin":""};
...
const EMPREENDIMENTOS = [
    {
      ...
      timeline: [
        {
          ...
          desc: "Movimentação de terra e fundações"
        },
        {
          date: "Jun 2026",
          title: "Estrutura concluída",
          desc: "Concretagem dos 32 pavimentos finalizada"
        },
        {
          date: "Dez 2026",
          title: "Acabamentos internos",
          desc: "Instalações elétricas, hidráulicas e revestimentos"
        },
        {
          date: "Jun 2027",
          title: "Entrega das chaves",
          desc: "Previsão de conclusão e entrega"
        }
      ],
      amenities: [
      ...
      prices: [
        {
          unit: "2 quartos (padrão)",
          area: "98 m²",
          value: "R$ 850.000"
        },
        {
          unit: "3 quartos (padrão)",
          area: "128 m²",
          value: "R$ 1.150.000"
        },
        {
          unit: "3 quartos (suíte)",
          area: "145 m²",
          value: "R$ 1.380.000",
          highlight: true
        },
        {
          unit: "4 quartos (suíte)",
          area: "180 m²",
          value: "R$ 1.750.000"
        },
        {
          unit: "Cobertura duplex",
          area: "210 m²",
          value: "R$ 2.800.000"
        }
      ],
      ...
      timeline: [
        {
          date: "Mar 2025",
          title: "Início das obras",
          desc: "Escavação e fundação das 4 torres"
        },
        {
          date: "Ago 2026",
          title: "Estrutura concluída",
          desc: "Todas as torres finalizadas estruturalmente"
        },
        {
          date: "Mai 2027",
          title: "Áreas comuns e lazer",
          desc: "Piscinas, paisagismo e áreas de convivência"
        },
        {
          date: "Dez 2027",
          title: "Entrega das chaves",
      ...
      timeline: [
        {
          date: "Abr 2025",
          title: "Início das obras",
          desc: "Preparação do terreno e fundações"
        },
        {
          date: "Out 2026",
          title: "Primeiras torres concluídas",
          desc: "Torres 1 a 4 com estrutura finalizada"
        },
        {
          date: "Set 2027",
          title: "Paisagismo e áreas comuns",
          desc: "Parque, lagoa e áreas de lazer"
        },
        {
          date: "Mar 2028",
          title: "Entrega das chaves",
          desc: "Previsão de conclusão geral"
        }
      ],
      amenities: [
...
const PARCEIROS = [
    ...
    },
    {
      ...
      img: "https://logo.clearbit.com/bb.com.br",
      url: "https://www.bb.com.br"
    },
    {
      name: "Itaú",
      img: "https://logo.clearbit.com/itau.com.br",
      url: "https://www.itau.com.br"
    },
    {
      name: "Santander",
      img: "https://logo.clearbit.com/santander.com.br",
      url: "https://www.santander.com.br"
    },
    {
      name: "Bradesco",
      img: "https://logo.clearbit.com/bradesco.com.br",
      url: "https://www.bradesco.com.br"
    },
    {
      name: "Sicredi",
      img: "https://logo.clearbit.com/sicredi.com.br",
